...
const megaDetails = {
  ...
  "برندها": { image: `${import.meta.env.BASE_URL}assets/hero-banner-makeup.webp`, title: "برندها", links: brands.slice(0, 4) },
  "راهنماها": { image: guides[0].image, title: "راهنمای انتخاب", links: ["ترکیبات پوست", "روتین روزانه", "مراقبت مو", "انتخاب رنگ"] },
  "پیشنهادهای ویژه": { image: `${import.meta.env.BASE_URL}assets/hero-banner-suncare.webp`, title: "پیشنهادهای ویژه", links: ["میز تخفیف", "پرفروش‌ها", "خرید روزمره", "موجودی محدود"] },
};
...
const heroSlides = [
  {
    ...
    leftImage: `${import.meta.env.BASE_URL}assets/hero-section/mulhens-left.png`,
    middleImage: `${import.meta.env.BASE_URL}assets/hero-section/mulhens-middle.png`,
  ...
  },
  {
    ...
    leftImage: `${import.meta.env.BASE_URL}assets/hero-section/Primer left.png`,
    middleImage: `${import.meta.env.BASE_URL}assets/hero-section/primer middle.png`,
