export const categories = [
  { id: "skin", title: "رنگ مو", image: "/assets/Categories/color.png" },
  { id: "hair", title: "مراقبت مو", image: "/assets/Categories/haircare.png" },
  { id: "makeup", title: "محصولات آرایشی", image: "/assets/Categories/makeup.png" },
  { id: "fragrance", title: "عطر و خوشبو کننده", image: "/assets/Categories/perfume.png" },
  { id: "body", title: "محصولات سالنی", image: "/assets/Categories/saloon.png" },
  { id: "personal-care", title: "بهداشت دهان و دندان", image: "/assets/Categories/dental-care.png" },
];

export const brandLogos = {
  "آپ اسکای": "/assets/Brands/آیکون-برند-آپ-اسکای.jpg",
  "آرکیا": "/assets/Brands/آیکون-برند-آرکیا.jpg",
  "اورادنت": "/assets/Brands/آیکون-برند-اورادنت.jpg",
  "بیس": "/assets/Brands/آیکون-برند-بیس.jpg",
  "پادینا": "/assets/Brands/آیکون-برند-پادینا.jpg",
  "تاکوری": "/assets/Brands/آیکون-برند-تاکوری.jpg",
  "جوو": "/assets/Brands/آیکون-برند-جوو.jpg",
  "کالیون": "/assets/Brands/آیکون-برند-کالیون.jpg",
  "لورینت": "/assets/Brands/آیکون-برند-لورینت.jpg",
  "مولهنس": "/assets/Brands/مولهنس.jpg",
  "وینا": "/assets/Brands/آیکون-برند-وینا.jpg",
};
...
export const products = localProductFiles.map(([collection, fileName], index) => {
  ...
  return {
    ...
    volume: "",
    origin: "ایران",
    image: `/assets/Products/${collection}/${fileName}`,
    alternate: "",
    concerns: [],
    suitable: "",
    ingredients: [],
